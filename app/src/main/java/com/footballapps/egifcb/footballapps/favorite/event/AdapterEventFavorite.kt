package com.footballapps.egifcb.footballapps.favorite.event
...
class AdapterEventFavorite(private val context: Context, private val event: List<Favorite>, private val listener: (Favorite) -> Unit)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
            AdapterEventFavorite.ViewHolder(LayoutInflater.from(context).inflate(R.layout.layout_list_last_event, parent, false))
